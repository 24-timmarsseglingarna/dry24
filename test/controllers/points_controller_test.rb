...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { definition: @point.definition, lat: @point.lat, long: @point.long, name: @point.name, number: @point.number }
    end
  ...
  test "should update point" do
    patch :update, id: @point, point: { definition: @point.definition, lat: @point.lat, long: @point.long, name: @point.name, number: @point.number }
    assert_redirected_to point_path(assigns(:point))
  end
